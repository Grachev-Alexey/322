...
--> statement-breakpoint
ALTER TABLE "package_perks" ADD CONSTRAINT "package_perks_package_type_packages_type_fk" FOREIGN KEY ("package_type") REFERENCES "public"."packages"("type") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
