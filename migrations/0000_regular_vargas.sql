...
CREATE TABLE "packages" (
	...
	"bonus_account_percent" numeric(3, 2) DEFAULT '0.00',
	"is_active" boolean DEFAULT true,
	"updated_at" timestamp DEFAULT now(),
...
ALTER TABLE "offers" ADD CONSTRAINT "offers_master_id_users_id_fk" FOREIGN KEY ("master_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
