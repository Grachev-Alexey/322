...
const IntegratedPackageComparison = ({ 
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {packageTypes.map((packageType) => {
          ...
          return (
            <div 
              key={packageType}
              className={`floating-card-enhanced bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl border-2 transition-all duration-300 overflow-hidden cursor-pointer relative ${
                isSelected 
            ...
            >
              ...
              {/* VIP Crown */}
              {packageType === 'vip' && (
                <div className="absolute top-0 right-0 w-12 h-12 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-bl-3xl rounded-tr-2xl flex items-end justify-start pl-2 pb-2">
              ...
              >
                ...
                {/* Discount Badge */}
                <div className={`inline-block px-3 py-1 rounded-lg text-xs font-bold text-white bg-gradient-to-r ${info.gradient} shadow-lg mb-3`}>
                ...
                <div className="mb-3">
                  ...
                  <div className="space-y-1 text-xs">
                    ...
                    {procedureCount >= 15 && data.appliedDiscounts.some((d: any) => d.type === 'bulk') && (
                      <div className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-2 py-1 rounded-lg font-medium">
                        +2,5% доп. скидка
                      </div>
                    )}
                    ...
                    {packageData && packageData.giftSessions > 0 && (
                      <div className="bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-400 px-2 py-1 rounded-lg font-medium">
                    ...
                    {data.monthlyPayment > 0 && (
                      <div className="bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 px-2 py-1 rounded-lg font-medium">
      ...
      <div className="floating-card-enhanced bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-gray-700/20 overflow-hidden shadow-xl">
        {/* Table Header */}
        <div className="grid grid-cols-4 gap-2 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 p-4">
          ...
          {packageTypes.map((packageType) => {
            ...
            return (
              <div key={packageType} className={`text-center font-bold text-sm ${
        ...
        <div className="divide-y divide-gray-100 dark:divide-gray-700">
          {uniquePerks.map((perk, index) => {
            ...
            return (
              <div key={perk.id} className={`grid grid-cols-4 gap-2 py-3 px-4 ${isEven ? 'bg-transparent' : 'bg-gray-50/30 dark:bg-gray-800/20'}`}>
                {/* Perk Name Column */}
                <div className="flex items-center space-x-3">
                  <div className="p-2 rounded-lg bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900 flex-shrink-0">
                ...
                {packageTypes.map((packageType) => {
                  ...
                  return (
                    <div key={packageType} className={`flex items-center justify-center min-h-[60px] rounded-lg transition-all duration-300 ${
                      isSelected ? 'bg-gradient-to-br from-blue-50/70 to-purple-50/70 dark:from-blue-900/20 dark:to-purple-900/20 border border-purple-200 dark:border-purple-700' : ''
                    }`}>
                      {!perkValue || !perkValue.isActive ? (
                        ...
                        <div className="flex flex-col items-center space-y-1">
                          {perkValue.valueType === 'boolean' ? (
                            ...
                            <>
                              <div className={`px-3 py-2 rounded-lg text-center min-w-[80px] shadow-md ${
